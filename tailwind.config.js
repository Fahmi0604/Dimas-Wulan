...
const namaTema = require('./src/translation.json')
const tema = require('./src/theme.json')
...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // 'primary': '#0B1A23',
        'primary': tema[namaTema.tema].colors.primary,
        'secondary': tema[namaTema.tema].colors.secondary,
        'custom-text': tema[namaTema.tema].colors.customText
      },
      backgroundColor: {
        'custom-overlay': 'rgba(11, 26, 35, 0.1)',
        'custom-overlay-lg': 'rgba(11, 26, 35, 0.5)',
        'custom-secondary': tema[namaTema.tema].backgroundColor.customSecondary,
        'custom-secondary-md': tema[namaTema.tema].backgroundColor.customSecondaryMd,
        'custom-white-sm': 'rgba(255, 255, 255, 0.1)',
        'custom-white-md': 'rgba(255, 255, 255, 0.3)',
        'custom-white-lg': 'rgba(255, 255, 255, 0.5)'
      },
      keyframes: {
        wave: {
